...
class PaperGridQty(models.Model):
    Inc = models.FloatField(primary_key=True)
    Dackle_Dim = models.FloatField(default=0)
    Grain_Dim = models.FloatField(default=0)
    Ups = models.IntegerField(default=0)
    AreaPerCarton_SqInch = models.FloatField(default=0)
    Scan = models.IntegerField(default=0)
    Grain = models.CharField(max_length=10, default='')
    MachineID = models.CharField(max_length=10, default='')
    MachineName = models.CharField(max_length=60, default='')
    NoOfPass_req = models.IntegerField(default=1)
    Mat_X = models.IntegerField(default=0)
    Mat_Y = models.IntegerField(default=0)
    DieLength_In_Inch = models.FloatField(null=True, default=0)
    Qty = models.FloatField(default=0)
    F_Color = models.IntegerField(default=0)
    B_Color = models.IntegerField(default=0)
    Die_PlanHeight = models.FloatField(default=0)
    Die_PlanWidth = models.FloatField(default=0)
    FullSheet_D = models.FloatField(default=0)
    FullSheet_G = models.FloatField(default=0)
    FullSheet_Grain = models.CharField(max_length=10, default='')
    FullSheet_Cut_X = models.IntegerField(default=0)
    FullSheet_Cut_Y = models.IntegerField(default=0)
    FullSheet_Ups = models.IntegerField(default=0)
    Sheets_A = models.FloatField(default=0)
    HeightCut = models.IntegerField(default=0)
    WidthCut = models.IntegerField(default=0)
    LengthRemaining = models.FloatField(default=0)
    WidthRemaining = models.FloatField(default=0)
    ItemsInFirstCut = models.IntegerField(default=0)
    TotalCuts = models.IntegerField(default=0)
    TotalBox = models.IntegerField(default=0)
    Dackle_Dim_B = models.FloatField(default=0)
    Grain_Dim_B = models.FloatField(default=0)
    Ups_B = models.IntegerField(default=0)
    Mat_X_B = models.IntegerField(default=0)
    Mat_Y_B = models.IntegerField(default=0)
    Cuts_B = models.IntegerField(default=0)
    Sheets_B = models.FloatField(default=0)
    Dackle_Dim_C = models.FloatField(default=0)
    Grain_Dim_C = models.FloatField(default=0)
    Ups_C = models.IntegerField(default=0)
    Mat_X_C = models.IntegerField(default=0)
    Mat_Y_C = models.IntegerField(default=0)
    Cuts_C = models.IntegerField(default=0)
    Sheets_C = models.FloatField(default=0)
    Dackle_Dim_D = models.FloatField(default=0)
    Grain_Dim_D = models.FloatField(default=0)
    Ups_D = models.IntegerField(default=0)
    Mat_X_D = models.IntegerField(default=0)
    Mat_Y_D = models.IntegerField(default=0)
    Cuts_D = models.IntegerField(default=0)
    Sheets_D = models.FloatField(default=0)
    Dackle_Dim_Tot = models.FloatField(default=0)
    Grain_Dim_Tot = models.FloatField(default=0)
    Wastage_X = models.FloatField(default=0)
    Wastage_Y = models.FloatField(default=0)
    Wastage_Weight_kg_A = models.FloatField(default=0)
    Wastage_Weight_kg_B = models.FloatField(default=0)
    Wastage_Weight_kg = models.FloatField(default=0)
    UtilizationPer = models.FloatField(default=0)
    FullSheet_Req = models.FloatField(default=0)
    PaperID = models.CharField(max_length=10, default='')
    Gsm = models.IntegerField(default=0)
    Paper_Rate = models.FloatField(default=0)
    Paper_Unit = models.CharField(max_length=10, default='')
    Print_Size_Sheets = models.FloatField(default=0)
    Print_Impression = models.IntegerField(default=0)
    Paper_Kg = models.FloatField(default=0)
    Paper_Kg_FullSheet = models.FloatField(default=0)
    Paper_Amt = models.FloatField(default=0)
    PunchDie_Amt = models.FloatField(default=0)
    Plate_Amt = models.FloatField(default=0)
    PrMake_Ready_Amt = models.FloatField(default=0)
    Printing_Amt = models.FloatField(default=0)
    Total_Amt = models.FloatField(default=0)
    PN_McID = models.CharField(max_length=10, default='')
    PN_MachineName = models.CharField(max_length=60, default='')
    PN_MaxDackle = models.IntegerField(default=0)
    PN_MinDackle = models.IntegerField(default=0)
    PN_MaxGrain = models.IntegerField(default=0)
    PN_MinGrain = models.IntegerField(default=0)
    PN_Gripper = models.IntegerField(default=0)
    PN_MakeRdy_Amt = models.FloatField(null=True, default=0)
    PN_Punching_Amt = models.FloatField(null=True, default=0)

    class Meta:
        managed = False
        db_table = 'papergrid_qty'