...
class ItemPiDetail(models.Model):
    ...
    insurance = models.FloatField(db_column='Insurance',default=0, blank=True)  
    ...
    hold = models.IntegerField(db_column='Hold',default=0, blank=True)  
    clstatus = models.IntegerField(db_column='CLStatus',default=0, blank=True)  
    approved = models.FloatField(db_column='Approved',default=0, blank=True)  
    approvedby = models.CharField(db_column='ApprovedBy', max_length=45)  
    approvaldate = models.DateTimeField(db_column='ApprovalDate',default="2060-01-01 00:00:00", blank=True)  
    ...
    closedate = models.DateTimeField(db_column='CloseDate',default="2060-01-01 00:00:00", blank=True)  
    ...
    orderqty = models.IntegerField(db_column='Orderqty',default=0, blank=True)  
